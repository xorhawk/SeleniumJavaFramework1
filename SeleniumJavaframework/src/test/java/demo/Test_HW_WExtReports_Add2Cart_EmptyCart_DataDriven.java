...
public class Test_HW_WExtReports_Add2Cart_EmptyCart_DataDriven {
	...
	public void tearDownTest() {
		...
		//close browser
				driver.close(); //Close current tab, if only one tab is open it will close the browser
				driver.quit(); //Close all tabs ie close browser window
